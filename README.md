...
| Area | Focus |
|------|-------|
| ☁️ **Cloud** | Getting hands-on with AWS EC2 & S3 for broadcast infrastructure |
| 📡 **IP Media** | Exploring SMPTE 2110 and IP-based live production workflows |
| 🎬 **Codecs** | Deepening knowledge of H.264, H.265, and audio codec pipelines |
| 🐙 **GitHub** | Building this portfolio — watch this space! |
